> **Archived research notes — not current product copy.** The shipping product is **APK Pilot** (v0.6.0). Testers download **`SingularityApkInstaller-win-x64-setup.exe`** from [GitHub Releases](https://github.com/LatePhoenix/singularity-apk-pilot/releases/latest). See [`README.md`](README.md) and [`docs/PRODUCT_SPEC.md`](docs/PRODUCT_SPEC.md).
